...
\AddToShipoutPicture*
  {\put(465,767){\href{https://github.com/stableholonomy/TheLaxWhiteheadTheoremforCoglobularLocallyPresentableStableInfinity-Topoi
/blob/main/TheLaxWhiteheadTheoremforCoglobularLocallyPresentableStableInfinity-Topoi
...
\AddToShipoutPicture*
  {\put(375,767){\href{https://github.com/stableholonomy/TheLaxWhiteheadTheoremforCoglobularLocallyPresentableStableInfinity-Topoi
/blob/main/TheLaxWhiteheadTheoremforCoglobularLocallyPresentableStableInfinity-Topoi
.lean}{\texttt{\raisebox{-0.1 em}{\includegraphics[width=0.30cm,height=0.30cm]{leanlogo.png}} Lean file}}}}

\AddToShipoutPicture*
  {\put(375,752){\href{https://github.com/stableholonomy/TheLaxWhiteheadTheoremforCoglobularLocallyPresentableStableInfinity-Topoi
/blob/main/TheLaxWhiteheadTheoremforCoglobularLocallyPresentableStableInfinity-Topoi
.agda}{\texttt{\raisebox{-0.09 em}{\includegraphics[width=0.33cm,height=0.31cm]{agdalogo.png}} Agda file}}}}

\AddToShipoutPicture*
  {\put(375,737){\href{https://github.com/stableholonomy/TheLaxWhiteheadTheoremforCoglobularLocallyPresentableStableInfinity-Topoi
/blob/main/TheLaxWhiteheadTheoremforCoglobularLocallyPresentableStableInfinity-Topoi
.v}{\texttt{\raisebox{-0.17 em}{\includegraphics[width=0.31cm,height=0.34cm]{coqlogo.png}} Coq file}}}}

  \AddToShipoutPicture*
  {\put(375,722){\href{https://github.com/stableholonomy/TheLaxWhiteheadTheoremforCoglobularLocallyPresentableStableInfinity-Topoi
/blob/main/TheLaxWhiteheadTheoremforCoglobularLocallyPresentableStableInfinity-Topoi
...
\AddToShipoutPicture*
  {\put(185,737){\href{https://github.com/stableholonomy/TheLaxWhiteheadTheoremforCoglobularLocallyPresentableStableInfinity-Topoi
/blob/main/TheLaxWhiteheadTheoremforCoglobularLocallyPresentableStableInfinity-Topoi
.tex}{\texttt{Latex file}}
  }}

\AddToShipoutPicture*
  {\put(185,722){\href{https://github.com/stableholonomy/TheLaxWhiteheadTheoremforCoglobularLocallyPresentableStableInfinity-Topoi
/blob/main/TheLaxWhiteheadTheoremforCoglobularLocallyPresentableStableInfinity-Topoi
.pdf}{\texttt{PDF file}}
  }}
...
\begin{center}
  ...
  \begin{center}
\scalebox{1.8}{\texttt{Categories and Hilbert Spaces}}
\end{center}
\end{tcolorbox}
\end{center}
